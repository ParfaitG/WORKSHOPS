...
barplot(graph_data, beside=TRUE, col=seaborn_palette[1:6], legend=NULL, 
        ylim=c(0,70), border="white", xaxs="i",
...
```{r fig3, fig.height = 8, fig.width = 13, fig.align = "center"}
plot_results[[31]]
plot.new()
invisible(dev.off())
```
...
with(results_df, {
  plot(time_stamp, time.mean, type='l',
       ...
       col=seaborn_palette[1], bg = "lightgray", xaxt="n", cex.main=1.5)
...
legend("topleft", legend=rownames(dat), fill=seaborn_palette[1:3])
box(col="gray50")
```
...
bp <- barplot(dat, col=seaborn_palette[3], ylim=range(pretty(c(0, dat))),
              ...
              cex.main=1.5, cex.lab=1.5)
legend("topleft", legend=rownames(dat), fill=seaborn_palette[3])
box(col="gray50")
```
...
bp <- barplot(dat, col=seaborn_palette[5:7], ylim=range(pretty(c(0, dat))),
              ...
              xlab="Row Size", ylab="Script Mean Runtime (sec.)", font.lab=2, 
              cex.main=1.5, cex.lab=1.5)
legend("topleft", legend=rownames(dat), fill=seaborn_palette[5:7])
box(col="gray50")
```
...
bp <- barplot(dat, col=seaborn_palette[7:10], ylim=range(pretty(c(0, dat))),
              beside=TRUE, legend=NULL, border="white",
              main="Timings By Row Size and CPU Cores", 
              xlab="Row Size", ylab="Script Mean Runtime (sec.)", font.lab=2, 
              cex.main=1.5, cex.lab=1.5)
legend("topleft", legend=rownames(dat), fill=seaborn_palette[7:10])
box(col="gray50")
```
...
bp <- barplot(dat, col=seaborn_palette[2:6], ylim=range(pretty(c(0, dat))),
              ...
              xlab="Row Size", ylab="Script Mean Runtime (sec.)", font.lab=2, 
              cex.main=1.5, cex.lab=1.5)
legend("topleft", legend=rownames(dat), fill=seaborn_palette[2:6])
box(col="gray50")
```
...
- ### Does type of specs matter (32-bit/64-bit, CPU cores, disk speed)?
