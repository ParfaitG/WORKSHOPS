...
<div style="float:right"><img src="IMAGES/cta_logo.png" height="200" width="200"/></div>
...
- ### <span style="color:#336791">Postgres maintains an expressive SQL dialect and efficient query compiler for data processing</span> ###
