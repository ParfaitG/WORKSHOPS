...
<div class="wrapper"><img src="Images/unstructured_data.jpg" style="height:450px;"/></div>  
...
- Client/Server Jobs: build schemas and objects on server, process data on client
