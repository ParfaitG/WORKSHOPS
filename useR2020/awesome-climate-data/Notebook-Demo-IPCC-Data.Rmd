...
```{r}
climate_df <- setNames(scenario_tables$`AII-1-1a`[c(2:98), c("Year", "CO2.(ppm)", "CH4.(ppb)", "N2O.(ppb)")],
...
```{r}
climate_df <- scenario_tables$`AII-2-1abc`[c(1:11), c("Year", "RCP2.6", "RCP4.5", "RCP6.0", "RCP8.5")]
...
```{r}
climate_df <- scenario_tables$`AII-2-1abc`[c(19:29), c("Year", "RCP2.6", "RCP4.5", "RCP6.0", "RCP8.5")]
...
```{r}
climate_df <- scenario_tables$`AII-2-1abc`[c(34:44), c("Year", "RCP2.6", "RCP4.5", "RCP6.0", "RCP8.5")]
...
```{r}
climate_df <- scenario_tables$`AII-2-2`[c(4:13), c("Year", "RCP2.6", "RCP4.5", "RCP6.0", "RCP8.5")]
...
```{r}
climate_df <- scenario_tables$`AII-2-3`[c(4:13), c("Year", "RCP2.6", "RCP4.5", "RCP6.0", "RCP8.5")]
...
```{r}
climate_df <- scenario_tables$`AII-4-1`[c(4:13), c("Year", "RCP2.6", "RCP4.5", "RCP6.0", "RCP8.5")]
...
```{r}
climate_df <- scenario_tables$`AII-4-2`[c(4:13), c("Year", "RCP2.6", "RCP4.5", "RCP6.0", "RCP8.5")]
...
```{r}
climate_df <- scenario_tables$`AII-4-3`[c(4:13), c("Year", "RCP2.6", "RCP4.5", "RCP6.0", "RCP8.5")]
