...
- ### I/O Interface: csv/txt, json, XML, HTML
- ### API Connections: httr, URL request, piping
- ### Remote Integrations: server, cloud computing

<center><img src="assets/R_Extendable_Environment.png" width="550px" /></center> 
...
- ### <span style="color:#336791">Seamless data type integration (i.e., timestamps, coordinate decimals)</span>
- ### <span style="color:#336791">Query specific data points without large in-memory footprint</span>
...
- ### <span style="color:#336791">Relational databases provides a stable, centralized, repository for data sourcing</span> ###
...
- ### <span style="color:#336791">Relational databases supports data science ensures best practices and reproducibility</span> ###
